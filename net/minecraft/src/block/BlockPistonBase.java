...
import net.minecraft.src.world.tile.TileEntityPiston;
  ...
  public void playBlock(World world, int i, int j, int k, int l, int i1) {
    ...
    if (l == 0) {
      ...
      world.setBlockTileEntity(
          i, j, k, BlockPistonMoving.func_31036_a(blockID, j1, j1, false, true));
      if (isSticky) {
        ...
        if (!flag
            ...
            && (Block.blocksList[j2].getMobilityFlag() == 0
                || j2 == Block.pistonBase.blockID
          ...
          world.setBlockTileEntity(
              i, j, k, BlockPistonMoving.func_31036_a(j2, k2, j1, false, false));
        } else if (!flag) {
          field_31048_b = false;
    ...
    for (; i1 != i || j1 != j || k1 != k; k1 = l2) {
      ...
      if (i3 == blockID && i2 == i && k2 == j && l2 == k) {
        ...
        world.setBlockTileEntity(
            ...
            j1,
            k1,
            BlockPistonMoving.func_31036_a(
                Block.pistonExtension.blockID, l | (isSticky ? 8 : 0), l, true, false));
      } else {
        world.setBlockAndMetadata(i1, j1, k1, Block.pistonMoving.blockID, j3);
        world.setBlockTileEntity(
            i1, j1, k1, BlockPistonMoving.func_31036_a(i3, j3, l, true, false));
      }
      i1 = i2;
      j1 = k2;
    }
