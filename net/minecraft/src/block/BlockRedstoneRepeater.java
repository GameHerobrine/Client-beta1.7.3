...
public class BlockRedstoneRepeater extends Block {
    ...
    if (isRepeaterPowered && !flag) {
      ...
      if (!flag) {
        ...
        world.scheduleBlockUpdate(
            i, j, k, Block.redstoneRepeaterActive.blockID, field_22023_b[i1] * 2);
      }
    }
  }
    ...
    switch (i1) {
      case 0: // '\0'
        return world.isBlockIndirectlyProvidingPowerTo(i, j, k + 1, 3)
            || world.getBlockId(i, j, k + 1) == Block.redstoneWire.blockID
      ...
      case 3: // '\003'
        return world.isBlockIndirectlyProvidingPowerTo(i + 1, j, k, 5)
            || world.getBlockId(i + 1, j, k) == Block.redstoneWire.blockID
  ...
  public void randomDisplayTick(World world, int i, int j, int k, Random random) {
    ...
    double d1 =
        (double) ((float) j + 0.4F) + (double) (random.nextFloat() - 0.5F) * 0.20000000000000001D;
    double d2 =
