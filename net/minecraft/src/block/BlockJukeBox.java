...
import net.minecraft.src.world.tile.TileEntityRecordPlayer;
  ...
  public void ejectRecord(World world, int i, int j, int k, int l) {
    if (world.multiplayerWorld) {
      ...
      TileEntityRecordPlayer tileentityrecordplayer =
          (TileEntityRecordPlayer) world.getBlockTileEntity(i, j, k);
  ...
  public void func_28038_b_(World world, int i, int j, int k) {
    ...
    if (l == 0) {
      ...
      EntityItem entityitem =
          new EntityItem(
              world, (double) i + d, (double) j + d1, (double) k + d2, new ItemStack(i1, 1, 0));
