...
public class BlockPistonMoving extends BlockContainer {
  ...
  public void dropBlockAsItemWithChance(World world, int i, int j, int k, int l, float f) {
    ...
    if (tileentitypiston == null) {
      ...
      Block.blocksList[tileentitypiston.getStoredBlockID()].dropBlockAsItem(
          world, i, j, k, tileentitypiston.getBlockMetadata());
      return;
    }
  }
  ...
  public AxisAlignedBB getCollisionBoundingBoxFromPool(World world, int i, int j, int k) {
    ...
    return func_31035_a(
        world, i, j, k, tileentitypiston.getStoredBlockID(), f, tileentitypiston.func_31009_d());
  }
  ...
  public AxisAlignedBB func_31035_a(World world, int i, int j, int k, int l, float f, int i1) {
    ...
    AxisAlignedBB axisalignedbb =
        Block.blocksList[l].getCollisionBoundingBoxFromPool(world, i, j, k);
