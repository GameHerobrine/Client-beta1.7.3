...
public class BlockFire extends Block {
      ...
      for (int j1 = k - 1; j1 <= k + 1; j1++) {
        for (int k1 = j - 1; k1 <= j + 4; k1++) {
          ...
          if (j2 <= 0
              ...
              || world.func_27161_C() && world.canBlockBeRainedOn(i1, k1, j1)
              || world.canBlockBeRainedOn(i1 - 1, k1, k)
              || world.canBlockBeRainedOn(i1 + 1, k1, j1)
              || world.canBlockBeRainedOn(i1, k1, j1 - 1)
              || world.canBlockBeRainedOn(i1, k1, j1 + 1)) {
            continue;
          }
  ...
  private void tryToCatchBlockOnFire(
      World world, int i, int j, int k, int l, Random random, int i1) {
