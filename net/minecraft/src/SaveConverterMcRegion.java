...
import net.minecraft.src.world.chunk.ChunkFile;
import net.minecraft.src.world.chunk.ChunkFilePattern;
import net.minecraft.src.world.chunk.ChunkFolderPattern;
...
public class SaveConverterMcRegion extends SaveFormatOld {
  ...
  public List<SaveFormatComparator> func_22176_b() {
    ArrayList<SaveFormatComparator> arraylist = new ArrayList<>();
