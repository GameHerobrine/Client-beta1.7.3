...
public class GuiSlotStatsItem extends GuiSlotStats {
  ...
  public final GuiStats field_27275_a; /* synthetic field */
  ...
  public GuiSlotStatsItem(GuiStats guistats) {
    ...
    while (iterator.hasNext()) {
      ...
      if (GuiStats.func_27142_c(guistats).writeStat(statcrafting) > 0) {
        flag = true;
      } else if (StatList.field_25170_B[i] != null
          && GuiStats.func_27142_c(guistats).writeStat(StatList.field_25170_B[i]) > 0) {
        flag = true;
      } else if (StatList.field_25158_z[i] != null
          && GuiStats.func_27142_c(guistats).writeStat(StatList.field_25158_z[i]) > 0) {
        flag = true;
      }
      if (flag) {
