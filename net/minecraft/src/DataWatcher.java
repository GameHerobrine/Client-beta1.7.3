...
public class DataWatcher {
  ...
  private static void writeWatchableObject(
      DataOutputStream dataoutputstream, WatchableObject watchableobject) throws IOException {
  ...
  public static List readWatchableObjects(DataInputStream datainputstream) throws IOException {
    ...
    for (byte byte0 = datainputstream.readByte();
        byte0 != 127;
  ...
  public void addObject(int i, Object obj) {
    ...
    if (i > 31) {
      throw new IllegalArgumentException(
          (new StringBuilder())
              .append("Data value id is too big with ")
              .append(i)
              .append("! (Max is ")
              .append(31)
              .append(")")
  ...
  public int getWatchableObjectInt(int i) {
    return ((Integer) ((WatchableObject) watchedObjects.get(Integer.valueOf(i))).getObject())
        .intValue();
  }
