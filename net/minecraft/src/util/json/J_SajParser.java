...
public final class J_SajParser {
  ...
  public void func_27463_a(Reader reader, J_JsonListener j_jsonlistener)
    ...
    J_PositionTrackingPushbackReader j_positiontrackingpushbackreader =
        new J_PositionTrackingPushbackReader(reader);
  ...
  private void func_27455_a(
      J_PositionTrackingPushbackReader j_positiontrackingpushbackreader,
      J_JsonListener j_jsonlistener)
      throws J_InvalidSyntaxException, IOException {
  ...
  private char func_27460_c(J_PositionTrackingPushbackReader j_positiontrackingpushbackreader)
    ...
    switch (c1) {
      ...
      default:
        throw new J_InvalidSyntaxException(
            (new StringBuilder())
                .append("Expected a digit 1 - 9 but got [")
                .append(c1)
                .append("].")
                .toString(),
            j_positiontrackingpushbackreader);
  ...
  private String func_27452_i(J_PositionTrackingPushbackReader j_positiontrackingpushbackreader)
    ...
    if ('"' != c) {
      throw new J_InvalidSyntaxException(
          (new StringBuilder()).append("Expected [\"] but got [").append(c).append("].").toString(),
          j_positiontrackingpushbackreader);
    }
    boolean flag = false;
    do {
  ...
  private char func_27457_j(J_PositionTrackingPushbackReader j_positiontrackingpushbackreader)
    ...
    switch (c1) {
      ...
      default:
        throw new J_InvalidSyntaxException(
            (new StringBuilder())
                .append("Unrecognised escape character [")
                .append(c1)
                .append("].")
                .toString(),
            j_positiontrackingpushbackreader);
  ...
  private int func_27450_k(J_PositionTrackingPushbackReader j_positiontrackingpushbackreader)
    ...
    if (i != 4) {
      throw new J_InvalidSyntaxException(
          (new StringBuilder())
              .append("Expected a 4 digit hexidecimal number but got only [")
              .append(i)
              .append("], namely [")
              .append(String.valueOf(ac, 0, i))
              .append("].")
              .toString(),
          j_positiontrackingpushbackreader);
    }
    ...
    try {
      ...
      throw new J_InvalidSyntaxException(
          (new StringBuilder())
              ...
              .append(String.valueOf(ac))
              .append("] as a hexidecimal number.")
              .toString(),
