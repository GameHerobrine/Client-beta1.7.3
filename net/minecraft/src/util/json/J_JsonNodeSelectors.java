...
//            J_JsonNodeSelector, J_JsonStringNodeSelector, J_JsonArrayNodeSelector,
// J_JsonObjectNodeSelector,
//            J_JsonNodeFactories, J_JsonFieldNodeSelector, J_JsonElementNodeSelector,
// J_ChainedFunctor,
//            J_JsonStringNode
...
public final class J_JsonNodeSelectors {
  ...
  private static J_JsonNodeSelector func_27352_a(
      Object aobj[], J_JsonNodeSelector j_jsonnodeselector) {
    J_JsonNodeSelector j_jsonnodeselector1 = j_jsonnodeselector;
    for (int i = aobj.length - 1; i >= 0; i--) {
      if (aobj[i] instanceof Integer) {
        j_jsonnodeselector1 =
            func_27345_a(func_27354_b(((Integer) aobj[i]).intValue()), j_jsonnodeselector1);
        continue;
      }
      if (aobj[i] instanceof String) {
        ...
        throw new IllegalArgumentException(
            (new StringBuilder())
                .append("Element [")
                .append(aobj[i])
                .append("] of path elements")
                .append(" [")
                .append(Arrays.toString(aobj))
                .append("] was of illegal type [")
                .append(aobj[i].getClass().getCanonicalName())
                .append("]; only Integer and String are valid.")
                .toString());
      }
    }
  ...
  private static J_JsonNodeSelector func_27345_a(
      J_JsonNodeSelector j_jsonnodeselector, J_JsonNodeSelector j_jsonnodeselector1) {
