...
public class TileEntityPiston extends TileEntity {
  ...
  private void func_31010_a(float f, float f1) {
    ...
    AxisAlignedBB axisalignedbb =
        Block.pistonMoving.func_31035_a(
            worldObj, xCoord, yCoord, zCoord, storedBlockID, f, field_31025_c);
    if (axisalignedbb != null) {
      List list = worldObj.getEntitiesWithinAABBExcludingEntity(null, axisalignedbb);
      if (!list.isEmpty()) {
        field_31018_m.addAll(list);
        Entity entity;
        for (Iterator iterator = field_31018_m.iterator();
            iterator.hasNext();
            entity.moveEntity(
                f1 * (float) PistonBlockTextures.field_31056_b[field_31025_c],
                f1 * (float) PistonBlockTextures.field_31059_c[field_31025_c],
                f1 * (float) PistonBlockTextures.field_31058_d[field_31025_c])) {
    ...
    if (field_31020_l < 1.0F) {
      ...
      if (worldObj.getBlockId(xCoord, yCoord, zCoord) == Block.pistonMoving.blockID) {
        worldObj.setBlockAndMetadataWithNotify(
            xCoord, yCoord, zCoord, storedBlockID, storedMetadata);
      }
    }
  }
