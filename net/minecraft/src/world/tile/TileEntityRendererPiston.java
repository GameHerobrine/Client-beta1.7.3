...
public class TileEntityRendererPiston extends TileEntitySpecialRenderer {
  ...
  public void func_31070_a(
      TileEntityPiston tileentitypiston, double d, double d1, double d2, float f) {
    ...
    if (block != null && tileentitypiston.func_31008_a(f) < 1.0F) {
      ...
      tessellator.setTranslationD(
          ((float) d - (float) tileentitypiston.xCoord) + tileentitypiston.func_31017_b(f),
          ((float) d1 - (float) tileentitypiston.yCoord) + tileentitypiston.func_31014_c(f),
          ((float) d2 - (float) tileentitypiston.zCoord) + tileentitypiston.func_31013_d(f));
      tessellator.setColorOpaque(1, 1, 1);
      if (block == Block.pistonExtension && tileentitypiston.func_31008_a(f) < 0.5F) {
        field_31071_b.func_31079_a(
            block,
        ...
        field_31071_b.func_31079_a(
            ...
            tileentitypiston.yCoord,
            tileentitypiston.zCoord,
            tileentitypiston.func_31008_a(f) < 0.5F);
        ...
        field_31071_b.func_31078_d(
            block, tileentitypiston.xCoord, tileentitypiston.yCoord, tileentitypiston.zCoord);
      } else {
        field_31071_b.func_31075_a(
            block, tileentitypiston.xCoord, tileentitypiston.yCoord, tileentitypiston.zCoord);
      }
