...
public class ChunkProviderHell implements IChunkProvider {
  ...
  public void func_4058_b(int i, int j, byte abyte0[]) {
    ...
    double d = 0.03125D;
    field_4162_p =
        field_4166_l.generateNoiseOctaves(
            field_4162_p, i * 16, j * 16, 0.0D, 16, 16, 1, d, d, 1.0D);
    field_4161_q =
        field_4166_l.generateNoiseOctaves(
            field_4161_q, i * 16, 109.0134D, j * 16, 16, 1, 16, d, 1.0D, d);
    field_4160_r =
        field_4165_m.generateNoiseOctaves(
            field_4160_r, i * 16, j * 16, 0.0D, 16, 16, 1, d * 2D, d * 2D, d * 2D);
    for (int k = 0; k < 16; k++) {
      for (int l = 0; l < 16; l++) {
        boolean flag =
            field_4162_p[k + l * 16] + hellRNG.nextDouble() * 0.20000000000000001D > 0.0D;
        boolean flag1 =
            field_4161_q[k + l * 16] + hellRNG.nextDouble() * 0.20000000000000001D > 0.0D;
  ...
  private double[] func_4057_a(double ad[], int i, int j, int k, int l, int i1, int j1) {
    ...
    field_4172_f =
        field_4177_a.generateNoiseOctaves(field_4172_f, i, j, k, l, 1, j1, 1.0D, 0.0D, 1.0D);
    field_4171_g =
        field_4176_b.generateNoiseOctaves(field_4171_g, i, j, k, l, 1, j1, 100D, 0.0D, 100D);
    field_4175_c =
        field_4167_k.generateNoiseOctaves(
            field_4175_c, i, j, k, l, i1, j1, d / 80D, d1 / 60D, d / 80D);
