  ...
  public void func_28169_a(EntityPlayer entityplayer, ItemStack itemstack) {
    ...
    for (int i = 0; i < field_28174_h.size(); i++) {
      ...
      if (mapinfo1.entityplayerObj.isDead
          || !mapinfo1.entityplayerObj.inventory.func_28018_c(itemstack)) {
        field_28172_j.remove(mapinfo1.entityplayerObj);
        field_28174_h.remove(mapinfo1);
        continue;
      }
      float f =
          (float) (mapinfo1.entityplayerObj.posX - (double) field_28180_b)
              / (float) (1 << field_28177_e);
      float f1 =
          (float) (mapinfo1.entityplayerObj.posZ - (double) field_28179_c)
              / (float) (1 << field_28177_e);
      int j = 64;
      int k = 64;
