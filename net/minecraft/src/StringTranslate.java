...
public class StringTranslate {
  ...
  private StringTranslate() {
    ...
    try {
      translateTable.load(
          (net.minecraft.src.StringTranslate.class).getResourceAsStream("/lang/en_US.lang"));
      translateTable.load(
          (net.minecraft.src.StringTranslate.class).getResourceAsStream("/lang/stats_US.lang"));
  ...
  public String translateNamedKey(String s) {
    return translateTable.getProperty(
        (new StringBuilder()).append(s).append(".name").toString(), "");
  }
}
