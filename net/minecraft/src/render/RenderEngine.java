...
public class RenderEngine {
  ...
  public int[] func_28149_a(String s) {
    ...
    try {
      ...
      if (s.startsWith("##")) {
        ai1 =
            func_28148_b(
                unwrapImageByColumns(
                    readTextureImage(texturepackbase.getResourceAsStream(s.substring(2)))));
  ...
  public void setupTexture(BufferedImage bufferedimage, int i) {
    ...
    if (useMipmaps) {
      ...
      GL11.glTexParameteri(
          3553 /*GL_TEXTURE_2D*/, 10240 /*GL_TEXTURE_MAG_FILTER*/, 9728 /*GL_NEAREST*/);
    } else {
      GL11.glTexParameteri(
          3553 /*GL_TEXTURE_2D*/, 10241 /*GL_TEXTURE_MIN_FILTER*/, 9728 /*GL_NEAREST*/);
      GL11.glTexParameteri(
          3553 /*GL_TEXTURE_2D*/, 10240 /*GL_TEXTURE_MAG_FILTER*/, 9728 /*GL_NEAREST*/);
    }
    if (blurTexture) {
      GL11.glTexParameteri(
          3553 /*GL_TEXTURE_2D*/, 10241 /*GL_TEXTURE_MIN_FILTER*/, 9729 /*GL_LINEAR*/);
      GL11.glTexParameteri(
          3553 /*GL_TEXTURE_2D*/, 10240 /*GL_TEXTURE_MAG_FILTER*/, 9729 /*GL_LINEAR*/);
    }
    if (clampTexture) {
      ...
      GL11.glTexParameteri(
          3553 /*GL_TEXTURE_2D*/, 10242 /*GL_TEXTURE_WRAP_S*/, 10497 /*GL_REPEAT*/);
      GL11.glTexParameteri(
          3553 /*GL_TEXTURE_2D*/, 10243 /*GL_TEXTURE_WRAP_T*/, 10497 /*GL_REPEAT*/);
    }
      ...
      for (int i1 = 1; i1 <= 4; i1++) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
          for (int k3 = 0; k3 < k2; k3++) {
            ...
            int j5 =
                weightedAverageColor(weightedAverageColor(i4, k4), weightedAverageColor(l4, i5));
  ...
  public int getTextureForDownloadableImage(String s, String s1) {
    ThreadDownloadImageData threaddownloadimagedata =
        (ThreadDownloadImageData) urlToImageDataMap.get(s);
    if (threaddownloadimagedata != null
      ...
      if (threaddownloadimagedata.textureName < 0) {
        threaddownloadimagedata.textureName =
            allocateAndSetupTexture(threaddownloadimagedata.image);
      } else {
      ...
      for (int k = 0; k < texturefx.tileSize; k++) {
        ...
        for (int i1 = 0; i1 < texturefx.tileSize; i1++) {
          GL11.glTexSubImage2D(
              ...
              (texturefx.iconIndex / 16) * 16 + i1 * 16,
              16,
              16,
              6408 /*GL_RGBA*/,
              5121 /*GL_UNSIGNED_BYTE*/,
  ...
  public void refreshTextures() {
    ...
    for (Iterator iterator = textureNameToImageMap.keySet().iterator();
        iterator.hasNext();
        setupTexture(bufferedimage, i)) {
    ...
    for (Iterator iterator3 = field_28151_c.keySet().iterator(); iterator3.hasNext(); ) {
      ...
      try {
        ...
        if (s1.startsWith("##")) {
          bufferedimage2 =
              unwrapImageByColumns(
                  readTextureImage(texturepackbase.getResourceAsStream(s1.substring(2))));
