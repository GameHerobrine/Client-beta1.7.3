  ...
  public StatsSyncher(Session session, StatFileWriter statfilewriter, File file) {
    ...
    field_27434_e =
        new File(
            ...
            (new StringBuilder())
                .append("stats_")
                .append(session.username.toLowerCase())
                .append("_unsent.dat")
                .toString());
    field_27433_f =
        new File(
    ...
    if (!session.username.toLowerCase().equals(session.username)) {
      ...
      func_28214_a(
          file,
          (new StringBuilder()).append("stats_").append(session.username).append(".dat").toString(),
          field_27433_f);
      func_28214_a(
          file,
          (new StringBuilder())
      ...
      func_28214_a(
          file,
          (new StringBuilder()).append("stats_").append(session.username).append(".old").toString(),
          field_27429_j);
      func_28214_a(
          file,
          (new StringBuilder())
      ...
      func_28214_a(
          file,
          (new StringBuilder()).append("stats_").append(session.username).append(".tmp").toString(),
          field_27431_h);
    }
