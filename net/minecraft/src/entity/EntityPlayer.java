...
import net.minecraft.src.util.nbt.NBTTagList;
...
public abstract class EntityPlayer extends EntityLiving {
  ...
  public EntityPlayer(World world) {
    ...
    setLocationAndAngles(
        (double) chunkcoordinates.x + 0.5D,
        chunkcoordinates.y + 1,
        (double) chunkcoordinates.z + 0.5D,
        0.0F,
        0.0F);
    health = 20;
  ...
  public static ChunkCoordinates func_25060_a(World world, ChunkCoordinates chunkcoordinates) {
    ...
    ichunkprovider.prepareChunk(chunkcoordinates.x - 3 >> 4, chunkcoordinates.z + 3 >> 4);
    ichunkprovider.prepareChunk(chunkcoordinates.x + 3 >> 4, chunkcoordinates.z + 3 >> 4);
    if (world.getBlockId(chunkcoordinates.x, chunkcoordinates.y, chunkcoordinates.z)
        != Block.blockBed.blockID) {
      return null;
    } else {
      ChunkCoordinates chunkcoordinates1 =
          BlockBed.getNearestEmptyChunkCoordinates(
              world, chunkcoordinates.x, chunkcoordinates.y, chunkcoordinates.z, 0);
  ...
  public void onUpdate() {
    UpdateEvent updateEventPre = new UpdateEvent(UpdateEvent.UpdateType.PRE);
    Dozer.getSingleton().getEventBus().post(updateEventPre);
    ...
    UpdateEvent updateEventPost = new UpdateEvent(UpdateEvent.UpdateType.POST);
    Dozer.getSingleton().getEventBus().post(updateEventPost);
  }
  ...
  public void updateCloak() {
    playerCloakUrl =
        (new StringBuilder())
            .append("http://icebergcraft.com:6543/api/Minecraft/GetCapeByUsername/?username=")
            .append(username)
            .append(".png")
            .toString();
  ...
  protected void alertWolves(EntityLiving entityliving, boolean flag) {
    ...
    do {
      ...
      if (entitywolf1.isWolfTamed()
          && entitywolf1.getTarget() == null
  ...
  public void wakeUpPlayer(boolean flag, boolean flag1, boolean flag2) {
    ...
    if (chunkcoordinates != null
        && worldObj.getBlockId(chunkcoordinates.x, chunkcoordinates.y, chunkcoordinates.z)
            == Block.blockBed.blockID) {
      BlockBed.setBedOccupied(
          worldObj, chunkcoordinates.x, chunkcoordinates.y, chunkcoordinates.z, false);
      ChunkCoordinates chunkcoordinates2 =
          BlockBed.getNearestEmptyChunkCoordinates(
              worldObj, chunkcoordinates.x, chunkcoordinates.y, chunkcoordinates.z, 0);
      if (chunkcoordinates2 == null) {
        chunkcoordinates2 =
            new ChunkCoordinates(chunkcoordinates.x, chunkcoordinates.y + 1, chunkcoordinates.z);
      }
      setPosition(
          (float) chunkcoordinates2.x + 0.5F,
  ...
  private boolean isInBed() {
    return worldObj.getBlockId(bedChunkCoordinates.x, bedChunkCoordinates.y, bedChunkCoordinates.z)
        == Block.blockBed.blockID;
  }
    ...
    if (bedChunkCoordinates != null) {
      int i =
          worldObj.getBlockMetadata(
              bedChunkCoordinates.x, bedChunkCoordinates.y, bedChunkCoordinates.z);
