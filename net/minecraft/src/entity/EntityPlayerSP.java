...
public class EntityPlayerSP extends EntityPlayer {
  ...
  public EntityPlayerSP(Minecraft minecraft, World world, Session session, int i) {
    ...
    if (session != null && session.username != null && session.username.length() > 0) {
      skinUrl =
          "http://icebergcraft.com:6543/api/Minecraft/GetSkinByUsername/?username="
              + username
              + ".png";
    }
  ...
  public void onLivingUpdate() {
    ...
    pushOutOfBlocks(
        posX - (double) width * 0.34999999999999998D,
        boundingBox.minY + 0.5D,
  ...
  public void oItemPickup(Entity entity, int i) {
