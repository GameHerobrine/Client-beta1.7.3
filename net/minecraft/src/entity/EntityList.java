...
public class EntityList {
  ...
  public static Entity createEntityInWorld(String s, World world) {
    ...
    try {
      ...
      if (class1 != null) {
        entity =
            (Entity)
                class1.getConstructor(new Class[] {World.class}).newInstance(new Object[] {world});
      }
    ...
    if (entity != null) {
      ...
      System.out.println(
          (new StringBuilder())
              ...
              .append(nbttagcompound.getString("id"))
              .toString());
    }
    return entity;
  }
  ...
  public static Entity createEntity(int i, World world) {
    ...
    if (entity == null) {
      System.out.println(
          (new StringBuilder()).append("Skipping Entity with id ").append(i).toString());
    }
    return entity;
  }
