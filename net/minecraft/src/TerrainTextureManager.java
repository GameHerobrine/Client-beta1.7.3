...
public class TerrainTextureManager {
  ...
  public TerrainTextureManager() {
    ...
    try {
      BufferedImage bufferedimage =
          ImageIO.read((net.minecraft.src.TerrainTextureManager.class).getResource("/terrain.png"));
  ...
  public void func_799_a(IsoImageBuffer isoimagebuffer) {
    ...
    int l = j + 16;
    Chunk chunk =
        world.getChunkFromChunkCoords(isoimagebuffer.field_1354_c, isoimagebuffer.field_1353_d);
