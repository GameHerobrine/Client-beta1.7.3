...
public class ModuleManager {
    ...
    public void init() {
        ...
        new Reflections("dozer.systems.module.impl").getTypesAnnotatedWith(ModuleInfo.class).forEach(this::addModule);
     ...
     * @return The module.
     */
    public Module getModuleByClass(Class<?> clazz) throws IllegalArgumentException {
        return moduleList.stream()
