...
import dozer.shader.renderer.DynamicTexture;
...
public class CustomFontRenderer extends CustomFont {
    ...
    public float drawString(String text, double x, double y, Color color, boolean shadow) {
        x -= 1;
        y -= 2;
        Color gsColor = new Color(color.getRGB());
            ...
            for (int i = 0; i < size; i++) {
                ...
                if ((character == '\u00A7') && (i < size)) {
                    ...
                    if (colorIndex < 16) {
                        ...
                        GL11.glColor4f((colorcode >> 16 & 0xFF) / 255.0F, (colorcode >> 8 & 0xFF) / 255.0F, (colorcode & 0xFF) / 255.0F, color.getAlpha());
                    }
