...
public abstract class Minecraft implements Runnable {
  ...
  public static void startMainThread(String s, String s1, String s2) {
    Frame frame =
        new Frame(Dozer.getSingleton().getName() + " " + Dozer.getSingleton().getVersion());
    ...
    MinecraftImpl minecraftimpl = new MinecraftImpl(frame, canvas, null, 1280, 720, false, frame);
        ...
        if (Keyboard.getEventKeyState()) {
          if (Keyboard.getEventKey() == 87) {
            ...
            if (currentScreen != null) {
              ...
              KeyPressEvent keyPressEvent = new KeyPressEvent(Keyboard.getEventKey());
              Dozer.getSingleton().getEventBus().post(keyPressEvent);
  ...
  public void usePortal() {
    ...
    if (thePlayer.dimension == -1) {
      ...
      thePlayer.setLocationAndAngles(
          d, thePlayer.posY, d1, thePlayer.rotationYaw, thePlayer.rotationPitch);
