...
public class TexturedQuad {
  ...
  public TexturedQuad(PositionTextureVertex apositiontexturevertex[], int i, int j, int k, int l) {
    ...
    float f = 0.0015625F;
    float f1 = 0.003125F;
    apositiontexturevertex[0] =
        apositiontexturevertex[0].setTexturePosition((float) k / 64F - f, (float) j / 32F + f1);
    apositiontexturevertex[1] =
        apositiontexturevertex[1].setTexturePosition((float) i / 64F + f, (float) j / 32F + f1);
    apositiontexturevertex[2] =
        apositiontexturevertex[2].setTexturePosition((float) i / 64F + f, (float) l / 32F - f1);
    apositiontexturevertex[3] =
        apositiontexturevertex[3].setTexturePosition((float) k / 64F - f, (float) l / 32F - f1);
  }

  public void flipFace() {
    PositionTextureVertex apositiontexturevertex[] =
        new PositionTextureVertex[vertexPositions.length];
