...
public class ItemRenderer {
  ...
  public ItemRenderer(Minecraft minecraft) {
    ...
    mc = minecraft;
    field_28131_f =
        new MapItemRenderer(minecraft.fontRenderer, minecraft.gameSettings, minecraft.renderEngine);
  }
  ...
  public void renderItemInFirstPerson(float f) {
    ...
    if (itemstack != null && itemstack.itemID == Item.mapItem.shiftedIndex) {
      ...
      GL11.glTranslatef(
          -f16 * 0.4F,
          MathHelper.sin(MathHelper.sqrt_float(f8) * 3.141593F * 2.0F) * 0.2F,
          -f12 * 0.2F);
      f8 = (1.0F - f2 / 45F) + 0.1F;
      if (f8 < 0.0F) {
        f8 = 0.0F;
      ...
      GL11.glBindTexture(
          ...
          mc.renderEngine.getTextureForDownloadableImage(
              mc.thePlayer.skinUrl, mc.thePlayer.getEntityTexture()));
      for (f12 = 0; f12 < 2; f12++) {
        f16 = f12 * 2 - 1;
        GL11.glPushMatrix();
      ...
      GL11.glTranslatef(
          -f17 * 0.4F,
          MathHelper.sin(MathHelper.sqrt_float(f9) * 3.141593F * 2.0F) * 0.2F,
          -f13 * 0.2F);
      ...
      GL11.glTranslatef(
          -f18 * 0.3F,
          MathHelper.sin(MathHelper.sqrt_float(f10) * 3.141593F * 2.0F) * 0.4F,
          -f14 * 0.4F);
