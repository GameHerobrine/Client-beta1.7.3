...
public class EntitySnowShovelFX extends EntityFX {
  ...
  public EntitySnowShovelFX(
      World world, double d, double d1, double d2, double d3, double d4, double d5) {
    this(world, d, d1, d2, d3, d4, d5, 1.0F);
  }

  public EntitySnowShovelFX(
      World world, double d, double d1, double d2, double d3, double d4, double d5, float f) {
    ...
    motionZ += d5;
    particleRed =
        particleGreen = particleBlue = 1.0F - (float) (Math.random() * 0.30000001192092896D);
    particleScale *= 0.75F;
    particleScale *= f;
