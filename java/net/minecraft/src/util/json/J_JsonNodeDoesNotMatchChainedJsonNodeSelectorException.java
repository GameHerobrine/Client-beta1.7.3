...
public final class J_JsonNodeDoesNotMatchChainedJsonNodeSelectorException
  ...
  private J_JsonNodeDoesNotMatchChainedJsonNodeSelectorException(J_Functor j_functor, List list) {
    super(
        (new StringBuilder())
            .append("Failed to match any JSON node at [")
            .append(func_27324_a(list))
            .append("]")
            .toString());
  ...
  static J_JsonNodeDoesNotMatchJsonNodeSelectorException func_27323_a(
    ...
    LinkedList linkedlist =
        new LinkedList(j_jsonnodedoesnotmatchchainedjsonnodeselectorexception.field_27325_b);
    linkedlist.add(j_jsonnodeselector);
    return new J_JsonNodeDoesNotMatchChainedJsonNodeSelectorException(
        j_jsonnodedoesnotmatchchainedjsonnodeselectorexception.field_27326_a, linkedlist);
  }
  ...
  public String toString() {
    return (new StringBuilder())
        .append("JsonNodeDoesNotMatchJsonNodeSelectorException{failedNode=")
        .append(field_27326_a)
        .append(", failPath=")
        .append(field_27325_b)
        .append('}')
        .toString();
  }
}
