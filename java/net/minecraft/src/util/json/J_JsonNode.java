...
//            J_JsonNodeSelectors, J_JsonNodeDoesNotMatchChainedJsonNodeSelectorException,
// J_JsonNodeSelector, J_JsonNodeFactories,
...
public abstract class J_JsonNode {
  ...
  private Object func_27219_a(
      J_JsonNodeSelector j_jsonnodeselector, J_JsonNode j_jsonnode, Object aobj[]) {
    try {
      return j_jsonnodeselector.func_27357_b(j_jsonnode);
    } catch (
        J_JsonNodeDoesNotMatchChainedJsonNodeSelectorException
            j_jsonnodedoesnotmatchchainedjsonnodeselectorexception) {
      throw J_JsonNodeDoesNotMatchPathElementsException.func_27319_a(
          j_jsonnodedoesnotmatchchainedjsonnodeselectorexception,
          aobj,
          J_JsonNodeFactories.func_27315_a(new J_JsonNode[] {j_jsonnode}));
    }
  }
}
