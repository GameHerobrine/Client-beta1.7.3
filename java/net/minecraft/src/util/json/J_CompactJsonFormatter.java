  ...
  public String func_27327_a(J_JsonRootNode j_jsonrootnode) {
    ...
    try {
      ...
      throw new RuntimeException(
          "Coding failure in Argo:  StringWriter gave an IOException", ioexception);
    }
  ...
  private void func_27328_a(J_JsonNode j_jsonnode, Writer writer) throws IOException {
    ...
    switch (EnumJsonNodeTypeMappingHelper.field_27341_a[j_jsonnode.func_27218_a().ordinal()]) {
      case 1: // '\001'
        ...
        for (Iterator iterator = j_jsonnode.func_27215_d().iterator();
            iterator.hasNext();
            func_27328_a(j_jsonnode1, writer)) {
      ...
      case 2: // '\002'
        ...
        for (Iterator iterator1 = (new TreeSet(j_jsonnode.func_27214_c().keySet())).iterator();
            iterator1.hasNext();
      ...
      case 3: // '\003'
        writer
            .append('"')
            .append((new J_JsonEscapedString(j_jsonnode.func_27216_b())).toString())
            .append('"');
        break;
      ...
      default:
        throw new RuntimeException(
            (new StringBuilder())
                .append("Coding failure in Argo:  Attempt to format a JsonNode of unknown type [")
                .append(j_jsonnode.func_27218_a())
                .append("];")
                .toString());
    }
  }
