  ...
  public void addRecipes(CraftingManager craftingmanager) {
    for (int i = 0; i < 16; i++) {
      craftingmanager.addShapelessRecipe(
          new ItemStack(Block.cloth, 1, BlockCloth.func_21035_d(i)),
          new Object[] {
    ...
    craftingmanager.addShapelessRecipe(
        new ItemStack(Item.dyePowder, 2, 1), new Object[] {Block.plantRed});
    craftingmanager.addShapelessRecipe(
        new ItemStack(Item.dyePowder, 3, 15), new Object[] {Item.bone});
    craftingmanager.addShapelessRecipe(
    ...
    craftingmanager.addShapelessRecipe(
        new ItemStack(Item.dyePowder, 3, 7),
        new Object[] {
    ...
    craftingmanager.addShapelessRecipe(
        new ItemStack(Item.dyePowder, 3, 13),
        new Object[] {
