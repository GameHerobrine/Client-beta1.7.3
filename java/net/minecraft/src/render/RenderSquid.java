...
public class RenderSquid extends RenderLiving {
  ...
  public void func_21008_a(
      EntitySquid entitysquid, double d, double d1, double d2, float f, float f1) {
  ...
  protected void func_21007_a(EntitySquid entitysquid, float f, float f1, float f2) {
    float f3 =
        entitysquid.field_21088_b + (entitysquid.field_21089_a - entitysquid.field_21088_b) * f2;
    float f4 =
        entitysquid.field_21086_f + (entitysquid.field_21087_c - entitysquid.field_21086_f) * f2;
  ...
  protected float func_21006_b(EntitySquid entitysquid, float f) {
    float f1 =
        entitysquid.field_21082_j + (entitysquid.field_21083_i - entitysquid.field_21082_j) * f;
    return f1;
  }
