...
public class RenderBlocks {
  ...
  private void func_31076_a(
      double d, double d1, double d2, double d3, double d4, double d5, float f, double d6) {
    int i = 108;
  ...
  public boolean renderBlockFire(Block block, int i, int j, int k) {
    ...
    if (blockAccess.isBlockNormalCube(i, j - 1, k)
        || Block.fire.canBlockCatchFire(blockAccess, i, j - 1, k)) {
  ...
  public boolean renderBlockRedstoneWire(Block block, int i, int j, int k) {
    ...
    boolean flag =
        BlockRedstoneWire.isPowerProviderOrWire(blockAccess, i - 1, j, k, 1)
            || !blockAccess.isBlockNormalCube(i - 1, j, k)
                && BlockRedstoneWire.isPowerProviderOrWire(blockAccess, i - 1, j - 1, k, -1);
    boolean flag1 =
        BlockRedstoneWire.isPowerProviderOrWire(blockAccess, i + 1, j, k, 3)
            || !blockAccess.isBlockNormalCube(i + 1, j, k)
                && BlockRedstoneWire.isPowerProviderOrWire(blockAccess, i + 1, j - 1, k, -1);
    boolean flag2 =
        BlockRedstoneWire.isPowerProviderOrWire(blockAccess, i, j, k - 1, 2)
            || !blockAccess.isBlockNormalCube(i, j, k - 1)
                && BlockRedstoneWire.isPowerProviderOrWire(blockAccess, i, j - 1, k - 1, -1);
    boolean flag3 =
        BlockRedstoneWire.isPowerProviderOrWire(blockAccess, i, j, k + 1, 0)
            || !blockAccess.isBlockNormalCube(i, j, k + 1)
                && BlockRedstoneWire.isPowerProviderOrWire(blockAccess, i, j - 1, k + 1, -1);
    if (!blockAccess.isBlockNormalCube(i, j + 1, k)) {
    ...
    if (!blockAccess.isBlockNormalCube(i, j + 1, k)) {
      ...
      if (blockAccess.isBlockNormalCube(i - 1, j, k)
        ...
        tessellator.addVertexWithUV(
            (float) i + 0.015625F, (float) (j + 1) + 0.021875F, k + 1, d3, d5);
        tessellator.addVertexWithUV((float) i + 0.015625F, j + 0, k + 1, d1, d5);
        tessellator.addVertexWithUV((float) i + 0.015625F, j + 0, k + 0, d1, d7);
        tessellator.addVertexWithUV(
            (float) i + 0.015625F, (float) (j + 1) + 0.021875F, k + 0, d3, d7);
        tessellator.setColorOpaque_F(f, f, f);
        tessellator.addVertexWithUV(
            (float) i + 0.015625F, (float) (j + 1) + 0.021875F, k + 1, d3, d5 + 0.0625D);
        ...
        tessellator.addVertexWithUV(
            (float) i + 0.015625F, (float) (j + 1) + 0.021875F, k + 0, d3, d7 + 0.0625D);
      }
      if (blockAccess.isBlockNormalCube(i + 1, j, k)
          && blockAccess.getBlockId(i + 1, j + 1, k) == Block.redstoneWire.blockID) {
        tessellator.setColorOpaque_F(f * f2, f * f3, f * f4);
        ...
        tessellator.addVertexWithUV(
            (float) (i + 1) - 0.015625F, (float) (j + 1) + 0.021875F, k + 1, d3, d7);
        tessellator.addVertexWithUV(
            (float) (i + 1) - 0.015625F, (float) (j + 1) + 0.021875F, k + 0, d3, d5);
        ...
        tessellator.addVertexWithUV(
            (float) (i + 1) - 0.015625F, (float) (j + 1) + 0.021875F, k + 1, d3, d7 + 0.0625D);
        tessellator.addVertexWithUV(
            (float) (i + 1) - 0.015625F, (float) (j + 1) + 0.021875F, k + 0, d3, d5 + 0.0625D);
      ...
      if (blockAccess.isBlockNormalCube(i, j, k - 1)
        ...
        tessellator.addVertexWithUV(
            i + 1, (float) (j + 1) + 0.021875F, (float) k + 0.015625F, d3, d7);
        tessellator.addVertexWithUV(
            i + 0, (float) (j + 1) + 0.021875F, (float) k + 0.015625F, d3, d5);
        ...
        tessellator.addVertexWithUV(
            i + 1, (float) (j + 1) + 0.021875F, (float) k + 0.015625F, d3, d7 + 0.0625D);
        tessellator.addVertexWithUV(
            i + 0, (float) (j + 1) + 0.021875F, (float) k + 0.015625F, d3, d5 + 0.0625D);
      ...
      if (blockAccess.isBlockNormalCube(i, j, k + 1)
        ...
        tessellator.setColorOpaque_F(f * f2, f * f3, f * f4);
        tessellator.addVertexWithUV(
            i + 1, (float) (j + 1) + 0.021875F, (float) (k + 1) - 0.015625F, d3, d5);
        ...
        tessellator.addVertexWithUV(
            i + 0, (float) (j + 1) + 0.021875F, (float) (k + 1) - 0.015625F, d3, d7);
        tessellator.setColorOpaque_F(f, f, f);
        tessellator.addVertexWithUV(
            i + 1, (float) (j + 1) + 0.021875F, (float) (k + 1) - 0.015625F, d3, d5 + 0.0625D);
        ...
        tessellator.addVertexWithUV(
            i + 0, (float) (j + 1) + 0.021875F, (float) (k + 1) - 0.015625F, d3, d7 + 0.0625D);
      }
    }
    return true;
  }
  ...
  public boolean renderBlockLadder(Block block, int i, int j, int k) {
    ...
    if (k1 == 5) {
      tessellator.addVertexWithUV(
          (float) i + f2, (float) (j + 1) + f1, (float) (k + 1) + f1, d, d2);
      tessellator.addVertexWithUV(
          (float) i + f2, (float) (j + 0) - f1, (float) (k + 1) + f1, d, d3);
      tessellator.addVertexWithUV(
          (float) i + f2, (float) (j + 0) - f1, (float) (k + 0) - f1, d1, d3);
      tessellator.addVertexWithUV(
          (float) i + f2, (float) (j + 1) + f1, (float) (k + 0) - f1, d1, d2);
    }
    if (k1 == 4) {
      tessellator.addVertexWithUV(
          (float) (i + 1) - f2, (float) (j + 0) - f1, (float) (k + 1) + f1, d1, d3);
      tessellator.addVertexWithUV(
          (float) (i + 1) - f2, (float) (j + 1) + f1, (float) (k + 1) + f1, d1, d2);
      tessellator.addVertexWithUV(
          (float) (i + 1) - f2, (float) (j + 1) + f1, (float) (k + 0) - f1, d, d2);
      tessellator.addVertexWithUV(
          (float) (i + 1) - f2, (float) (j + 0) - f1, (float) (k + 0) - f1, d, d3);
    }
    if (k1 == 3) {
      tessellator.addVertexWithUV(
          (float) (i + 1) + f1, (float) (j + 0) - f1, (float) k + f2, d1, d3);
      tessellator.addVertexWithUV(
          (float) (i + 1) + f1, (float) (j + 1) + f1, (float) k + f2, d1, d2);
      tessellator.addVertexWithUV(
          (float) (i + 0) - f1, (float) (j + 1) + f1, (float) k + f2, d, d2);
      tessellator.addVertexWithUV(
          (float) (i + 0) - f1, (float) (j + 0) - f1, (float) k + f2, d, d3);
    }
    if (k1 == 2) {
      tessellator.addVertexWithUV(
          (float) (i + 1) + f1, (float) (j + 1) + f1, (float) (k + 1) - f2, d, d2);
      tessellator.addVertexWithUV(
          (float) (i + 1) + f1, (float) (j + 0) - f1, (float) (k + 1) - f2, d, d3);
      tessellator.addVertexWithUV(
          (float) (i + 0) - f1, (float) (j + 0) - f1, (float) (k + 1) - f2, d1, d3);
      tessellator.addVertexWithUV(
          (float) (i + 0) - f1, (float) (j + 1) + f1, (float) (k + 1) - f2, d1, d2);
    }
    return true;
  }
  ...
  public void renderTorchAtAngle(
      Block block, double d, double d1, double d2, double d3, double d4) {
    Tessellator tessellator = Tessellator.instance;
    ...
    double d14 = 0.625D;
    tessellator.addVertexWithUV(
        (d + d3 * (1.0D - d14)) - d13, d1 + d14, (d2 + d4 * (1.0D - d14)) - d13, d5, d6);
    tessellator.addVertexWithUV(
        (d + d3 * (1.0D - d14)) - d13, d1 + d14, d2 + d4 * (1.0D - d14) + d13, d5, d8);
    tessellator.addVertexWithUV(
        d + d3 * (1.0D - d14) + d13, d1 + d14, d2 + d4 * (1.0D - d14) + d13, d7, d8);
    tessellator.addVertexWithUV(
        d + d3 * (1.0D - d14) + d13, d1 + d14, (d2 + d4 * (1.0D - d14)) - d13, d7, d6);
  ...
  public boolean renderBlockFluids(Block block, int i, int j, int k) {
    ...
    if (renderAllFaces || flag) {
      ...
      tessellator.addVertexWithUV(
          ...
          (float) j + f7,
          k + 0,
          d2 - (double) f16 - (double) f14,
          (d3 - (double) f16) + (double) f14);
      tessellator.addVertexWithUV(
          i + 0,
          (float) j + f8,
          k + 1,
  ...
  public boolean renderStandardBlockWithAmbientOcclusion(
      Block block, int i, int j, int k, float f, float f1, float f2) {
    enableAO = true;
    boolean flag = false;
    ...
    if (renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j - 1, k, 0)) {
      ...
      colorRedTopLeft =
          colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag1 ? f : 1.0F) * 0.5F;
      colorGreenTopLeft =
          colorGreenBottomLeft =
              colorGreenBottomRight = colorGreenTopRight = (flag1 ? f1 : 1.0F) * 0.5F;
      colorBlueTopLeft =
          colorBlueBottomLeft =
              colorBlueBottomRight = colorBlueTopRight = (flag1 ? f2 : 1.0F) * 0.5F;
      colorRedTopLeft *= f4;
    ...
    if (renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j + 1, k, 1)) {
      ...
      colorRedTopLeft =
          colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = flag2 ? f : 1.0F;
      colorGreenTopLeft =
          colorGreenBottomLeft = colorGreenBottomRight = colorGreenTopRight = flag2 ? f1 : 1.0F;
      colorBlueTopLeft =
          colorBlueBottomLeft = colorBlueBottomRight = colorBlueTopRight = flag2 ? f2 : 1.0F;
      colorRedTopLeft *= f5;
    ...
    if (renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k - 1, 2)) {
      ...
      colorRedTopLeft =
          colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag3 ? f : 1.0F) * 0.8F;
      colorGreenTopLeft =
          colorGreenBottomLeft =
              colorGreenBottomRight = colorGreenTopRight = (flag3 ? f1 : 1.0F) * 0.8F;
      colorBlueTopLeft =
          colorBlueBottomLeft =
              colorBlueBottomRight = colorBlueTopRight = (flag3 ? f2 : 1.0F) * 0.8F;
      colorRedTopLeft *= f6;
    ...
    if (renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k + 1, 3)) {
      ...
      colorRedTopLeft =
          colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag4 ? f : 1.0F) * 0.8F;
      colorGreenTopLeft =
          colorGreenBottomLeft =
              colorGreenBottomRight = colorGreenTopRight = (flag4 ? f1 : 1.0F) * 0.8F;
      colorBlueTopLeft =
          colorBlueBottomLeft =
              colorBlueBottomRight = colorBlueTopRight = (flag4 ? f2 : 1.0F) * 0.8F;
      colorRedTopLeft *= f7;
    ...
    if (renderAllFaces || block.shouldSideBeRendered(blockAccess, i - 1, j, k, 4)) {
      ...
      colorRedTopLeft =
          colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag5 ? f : 1.0F) * 0.6F;
      colorGreenTopLeft =
          colorGreenBottomLeft =
              colorGreenBottomRight = colorGreenTopRight = (flag5 ? f1 : 1.0F) * 0.6F;
      colorBlueTopLeft =
          colorBlueBottomLeft =
              colorBlueBottomRight = colorBlueTopRight = (flag5 ? f2 : 1.0F) * 0.6F;
      colorRedTopLeft *= f8;
    ...
    if (renderAllFaces || block.shouldSideBeRendered(blockAccess, i + 1, j, k, 5)) {
      ...
      colorRedTopLeft =
          colorRedBottomLeft = colorRedBottomRight = colorRedTopRight = (flag6 ? f : 1.0F) * 0.6F;
      colorGreenTopLeft =
          colorGreenBottomLeft =
              colorGreenBottomRight = colorGreenTopRight = (flag6 ? f1 : 1.0F) * 0.6F;
      colorBlueTopLeft =
          colorBlueBottomLeft =
              colorBlueBottomRight = colorBlueTopRight = (flag6 ? f2 : 1.0F) * 0.6F;
      colorRedTopLeft *= f9;
      ...
      for (int i1 = 0; i1 < 4; i1++) {
        ...
        if (i1 == 2) {
          block.setBlockBounds(
              0.5F - f4, 1.0F - f4 * 3F, -f4 * 2.0F, 0.5F + f4, 1.0F - f4, 1.0F + f4 * 2.0F);
        }
        if (i1 == 3) {
          block.setBlockBounds(
              0.5F - f4, 0.5F - f4 * 3F, -f4 * 2.0F, 0.5F + f4, 0.5F - f4, 1.0F + f4 * 2.0F);
        }
        GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, -1F, 0.0F);
