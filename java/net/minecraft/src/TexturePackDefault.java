...
public class TexturePackDefault extends TexturePackBase {
  ...
  public TexturePackDefault() {
    ...
    try {
      texturePackThumbnail =
          ImageIO.read((net.minecraft.src.TexturePackDefault.class).getResource("/pack.png"));
  ...
  public void bindThumbnailTexture(Minecraft minecraft) {
    ...
    if (texturePackThumbnail != null) {
      ...
      GL11.glBindTexture(
          3553 /*GL_TEXTURE_2D*/, minecraft.renderEngine.getTexture("/gui/unknown_pack.png"));
    }
  }
}
