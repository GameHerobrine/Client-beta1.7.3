...
import net.minecraft.src.world.chunk.ChunkCoordinates;
import net.minecraft.src.world.tile.TileEntity;
import net.minecraft.src.world.tile.TileEntityDispenser;
import net.minecraft.src.world.tile.TileEntityFurnace;
...
//            EntityPainting, Packet25EntityPainting, Packet28EntityVelocity,
...
public class NetClientHandler extends NetHandler {
  ...
  public void func_6498_a(Packet28EntityVelocity packet28entityvelocity) {
    ...
    if (entity == null) {
      ...
      entity.setVelocity(
          (double) packet28entityvelocity.motionX / 8000D,
  ...
  public void handleNamedEntitySpawn(Packet20NamedEntitySpawn packet20namedentityspawn) {
    ...
    EntityOtherPlayerMP entityotherplayermp =
        new EntityOtherPlayerMP(mc.theWorld, packet20namedentityspawn.name);
  ...
  public void handleEntity(Packet30Entity packet30entity) {
    ...
    if (entity == null) {
      ...
      double d2 = (double) entity.serverPosZ / 32D;
      float f =
          packet30entity.rotating ? (float) (packet30entity.yaw * 360) / 256F : entity.rotationYaw;
      float f1 =
          packet30entity.rotating
              ? (float) (packet30entity.pitch * 360) / 256F
  ...
  public void handlePreChunk(Packet50PreChunk packet50prechunk) {
    worldClient.doPreChunk(
        packet50prechunk.xPosition, packet50prechunk.yPosition, packet50prechunk.mode);
  }

  public void handleMultiBlockChange(Packet52MultiBlockChange packet52multiblockchange) {
    Chunk chunk =
        worldClient.getChunkFromChunkCoords(
            packet52multiblockchange.xPosition, packet52multiblockchange.zPosition);
  ...
  public void handleBlockChange(Packet53BlockChange packet53blockchange) {
    worldClient.func_714_c(
        packet53blockchange.xPosition,
        packet53blockchange.yPosition,
        packet53blockchange.zPosition,
        packet53blockchange.type,
        packet53blockchange.metadata);
  }
  ...
  public void handleCollect(Packet22Collect packet22collect) {
    ...
    if (entity != null) {
      worldClient.playSoundAtEntity(
          entity, "random.pop", 0.2F, ((rand.nextFloat() - rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);
  ...
  public void func_22186_a(Packet17Sleep packet17sleep) {
    ...
    if (packet17sleep.field_22046_e == 0) {
      ...
      entityplayer.sleepInBedAt(
          packet17sleep.field_22044_b, packet17sleep.field_22048_c, packet17sleep.field_22047_d);
    }
  }
    ...
    if (packet2handshake.username.equals("-")) {
      ...
      try {
        URL url =
            new URL(
                (new StringBuilder())
                    .append("http://www.minecraft.net/game/joinserver.jsp?user=")
                    .append(mc.session.username)
                    .append("&sessionId=")
                    .append(mc.session.sessionId)
                    .append("&serverId=")
                    .append(packet2handshake.username)
                    .toString());
  ...
  public void handleMobSpawn(Packet24MobSpawn packet24mobspawn) {
    ...
    EntityLiving entityliving =
        (EntityLiving) EntityList.createEntity(packet24mobspawn.type, mc.theWorld);
  ...
  public void handleSpawnPosition(Packet6SpawnPosition packet6spawnposition) {
    mc.thePlayer.setPlayerSpawnCoordinate(
        new ChunkCoordinates(
            packet6spawnposition.xPosition,
            packet6spawnposition.yPosition,
  ...
  public void func_9448_a(Packet9Respawn packet9respawn) {
    if (packet9respawn.field_28048_a != mc.thePlayer.dimension) {
      ...
      worldClient =
          new WorldClient(
              this, worldClient.getWorldInfo().getRandomSeed(), packet9respawn.field_28048_a);
      worldClient.multiplayerWorld = true;
      mc.changeWorld1(worldClient);
  ...
  public void func_20087_a(Packet100OpenWindow packet100openwindow) {
    if (packet100openwindow.inventoryType == 0) {
      InventoryBasic inventorybasic =
          new InventoryBasic(packet100openwindow.windowTitle, packet100openwindow.slotsCount);
  ...
  public void func_20088_a(Packet103SetSlot packet103setslot) {
    if (packet103setslot.windowId == -1) {
      ...
      ItemStack itemstack =
          mc.thePlayer.inventorySlots.getSlot(packet103setslot.itemSlot).getStack();
      ...
      if (packet106transaction.field_20030_c) {
        ...
        addToSendQueue(
            new Packet106Transaction(
                packet106transaction.windowId, packet106transaction.field_20028_b, true));
      }
    }
  }
  ...
  public void func_20090_a(Packet105UpdateProgressbar packet105updateprogressbar) {
    ...
    if (mc.thePlayer.craftingInventory != null
      ...
      mc.thePlayer.craftingInventory.func_20112_a(
          packet105updateprogressbar.progressBar, packet105updateprogressbar.progressBarValue);
    }
  }
  ...
  public void func_28116_a(Packet131MapData packet131mapdata) {
    if (packet131mapdata.field_28055_a == Item.mapItem.shiftedIndex) {
      ...
      System.out.println(
          (new StringBuilder())
              .append("Unknown itemid: ")
              .append(packet131mapdata.field_28054_b)
              .toString());
    }
  }

  public void func_28115_a(Packet61DoorChange packet61doorchange) {
    mc.theWorld.func_28106_e(
  ...
  public void func_27245_a(Packet200Statistic packet200statistic) {
    ((EntityClientPlayerMP) mc.thePlayer)
        .func_27027_b(
