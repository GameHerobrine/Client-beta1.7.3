...
public class LoadingScreenRenderer implements IProgressUpdate {
  ...
  public void func_597_c(String s) {
    if (!mc.running) {
      ...
      GL11.glLoadIdentity();
      GL11.glOrtho(
          0.0D, scaledresolution.field_25121_a, scaledresolution.field_25120_b, 0.0D, 100D, 300D);
  ...
  public void setLoadingProgress(int i) {
    ...
    mc.fontRenderer.drawStringWithShadow(
        field_1007_c,
        (j - mc.fontRenderer.getStringWidth(field_1007_c)) / 2,
        k / 2 - 4 - 16,
        0xffffff);
    mc.fontRenderer.drawStringWithShadow(
        field_1004_a,
        (j - mc.fontRenderer.getStringWidth(field_1004_a)) / 2,
        (k / 2 - 4) + 8,
        0xffffff);
    Display.update();
    try {
