...
public class TileEntityMobSpawnerRenderer extends TileEntitySpecialRenderer {
  ...
  public void renderTileEntityMobSpawner(
      TileEntityMobSpawner tileentitymobspawner, double d, double d1, double d2, float f) {
    GL11.glPushMatrix();
    ...
    if (entity != null) {
      ...
      GL11.glRotatef(
          (float)
                  (tileentitymobspawner.yaw2
                      + (tileentitymobspawner.yaw - tileentitymobspawner.yaw2) * (double) f)
              * 10F,
          0.0F,
          1.0F,
          0.0F);
