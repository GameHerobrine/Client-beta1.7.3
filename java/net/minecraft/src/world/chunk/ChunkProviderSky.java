...
public class ChunkProviderSky implements IChunkProvider {
  ...
  public void func_28072_a(int i, int j, byte abyte0[], BiomeGenBase abiomegenbase[]) {
    double d = 0.03125D;
    field_28079_r =
        field_28083_n.generateNoiseOctaves(
            field_28079_r, i * 16, j * 16, 0.0D, 16, 16, 1, d, d, 1.0D);
    field_28078_s =
        field_28083_n.generateNoiseOctaves(
            field_28078_s, i * 16, 109.0134D, j * 16, 16, 1, 16, d, 1.0D, d);
    field_28077_t =
        field_28082_o.generateNoiseOctaves(
            field_28077_t, i * 16, j * 16, 0.0D, 16, 16, 1, d * 2D, d * 2D, d * 2D);
    for (int k = 0; k < 16; k++) {
      for (int l = 0; l < 16; l++) {
  ...
  public Chunk provideChunk(int i, int j) {
    ...
    field_28075_v =
        field_28081_p
            ...
            .loadBlockGeneratorData(field_28075_v, i * 16, j * 16, 16, 16);
  ...
  private double[] func_28073_a(double ad[], int i, int j, int k, int l, int i1, int j1) {
    ...
    d *= 2D;
    field_28093_d =
        field_28084_m.generateNoiseOctaves(
            field_28093_d, i, j, k, l, i1, j1, d / 80D, d1 / 160D, d / 80D);
  ...
  public void populate(IChunkProvider ichunkprovider, int i, int j) {
    ...
    if (field_28087_j.nextInt(4) == 0) {
      ...
      (new WorldGenLakes(Block.waterStill.blockID))
          .generate(field_28081_p, field_28087_j, i1, l4, i8);
    }
    if (field_28087_j.nextInt(8) == 0) {
      ...
      if (i5 < 64 || field_28087_j.nextInt(10) == 0) {
        (new WorldGenLakes(Block.lavaStill.blockID))
            .generate(field_28081_p, field_28087_j, j1, i5, j8);
      }
    }
    ...
    for (int j2 = 0; j2 < 20; j2++) {
      ...
      (new WorldGenMinable(Block.dirt.blockID, 32))
          .generate(field_28081_p, field_28087_j, l5, i9, k13);
    }
    ...
    for (int k2 = 0; k2 < 10; k2++) {
      ...
      (new WorldGenMinable(Block.gravel.blockID, 32))
          .generate(field_28081_p, field_28087_j, i6, j9, l13);
    }
    ...
    for (int i3 = 0; i3 < 20; i3++) {
      ...
      (new WorldGenMinable(Block.oreCoal.blockID, 16))
          .generate(field_28081_p, field_28087_j, j6, k9, i14);
    }
    ...
    for (int j3 = 0; j3 < 20; j3++) {
      ...
      (new WorldGenMinable(Block.oreIron.blockID, 8))
          .generate(field_28081_p, field_28087_j, k6, l9, j14);
    }
    ...
    for (int k3 = 0; k3 < 2; k3++) {
      ...
      (new WorldGenMinable(Block.oreGold.blockID, 8))
          .generate(field_28081_p, field_28087_j, l6, i10, k14);
    }
    ...
    for (int l3 = 0; l3 < 8; l3++) {
      ...
      (new WorldGenMinable(Block.oreRedstone.blockID, 7))
          .generate(field_28081_p, field_28087_j, i7, j10, l14);
    }
    ...
    for (int i4 = 0; i4 < 1; i4++) {
      ...
      (new WorldGenMinable(Block.oreDiamond.blockID, 7))
          .generate(field_28081_p, field_28087_j, j7, k10, i15);
    }
    ...
    for (int j4 = 0; j4 < 1; j4++) {
      ...
      (new WorldGenMinable(Block.oreLapis.blockID, 6))
          .generate(field_28081_p, field_28087_j, k7, l10, j15);
    }

    d = 0.5D;
    int k4 =
        (int)
            ((field_28094_c.func_806_a((double) k * d, (double) l * d) / 8D
                    + field_28087_j.nextDouble() * 4D
                    + 4D)
                / 3D);
    int l7 = 0;
    ...
    for (int i11 = 0; i11 < l7; i11++) {
      ...
      worldgenerator.generate(
          field_28081_p, field_28087_j, k15, field_28081_p.getHeightValue(k15, j18), j18);
    }
    ...
    for (int j11 = 0; j11 < 2; j11++) {
      ...
      (new WorldGenFlowers(Block.plantYellow.blockID))
          .generate(field_28081_p, field_28087_j, l15, k18, i21);
    }
    ...
    if (field_28087_j.nextInt(2) == 0) {
      ...
      (new WorldGenFlowers(Block.plantRed.blockID))
          .generate(field_28081_p, field_28087_j, k11, i16, l18);
    }
    if (field_28087_j.nextInt(4) == 0) {
      ...
      (new WorldGenFlowers(Block.mushroomBrown.blockID))
          .generate(field_28081_p, field_28087_j, l11, j16, i19);
    }
    if (field_28087_j.nextInt(8) == 0) {
      ...
      (new WorldGenFlowers(Block.mushroomRed.blockID))
          .generate(field_28081_p, field_28087_j, i12, k16, j19);
    }
    ...
    for (int k17 = 0; k17 < 50; k17++) {
      ...
      (new WorldGenLiquids(Block.waterMoving.blockID))
          .generate(field_28081_p, field_28087_j, j20, l21, l22);
    }
    ...
    for (int l17 = 0; l17 < 20; l17++) {
      ...
      (new WorldGenLiquids(Block.lavaMoving.blockID))
          .generate(field_28081_p, field_28087_j, k20, i22, i23);
    }

    field_28074_w =
        field_28081_p.getWorldChunkManager().getTemperatures(field_28074_w, k + 8, l + 8, 16, 16);
    for (int i18 = k + 8; i18 < k + 8 + 16; i18++) {
      for (int l20 = l + 8; l20 < l + 8 + 16; l20++) {
        ...
        double d1 =
            field_28074_w[j22 * 16 + j23] - ((double) (k23 - 64) / 64D) * 0.29999999999999999D;
        if (d1 < 0.5D
            && k23 > 0
            && k23 < 128
            && field_28081_p.isAirBlock(i18, k23, l20)
            && field_28081_p.getBlockMaterial(i18, k23 - 1, l20).getIsSolid()
            && field_28081_p.getBlockMaterial(i18, k23 - 1, l20) != Material.ice) {
