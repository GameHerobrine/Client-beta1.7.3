...
public class CanvasIsomPreview extends Canvas
  ...
  public void loadWorld(String s) {
    ...
    worldObj =
        new World(
            new SaveHandler(new File(dataFolder, "saves"), s, false), s, (new Random()).nextLong());
  ...
  public void drawScreen(Graphics2D graphics2d) {
    ...
    if (worldObj != null) {
      ...
      graphics2d.translate(
          -(chunkcoordinates.x + chunkcoordinates.z),
          -(-chunkcoordinates.x + chunkcoordinates.z) + 64);
    }
    ...
    if (displayHelpText) {
      ...
      String s =
          "F1 - F5: load levels   |   0-9: Set time of day   |   Space: return to spawn   |   Double click: zoom   |   Escape: hide this text";
      graphics2d.drawString(
          s, getWidth() / 2 - graphics2d.getFontMetrics().stringWidth(s) / 2, j1 + 20);
    }
    graphics2d.dispose();
  }
