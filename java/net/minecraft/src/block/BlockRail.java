...
public class BlockRail extends Block {
  ...
  public void onNeighborBlockChange(World world, int i, int j, int k, int l) {
    ...
    if (flag) {
      ...
      flag1 =
          flag1
              || func_27044_a(world, i, j, k, i1, true, 0)
              || func_27044_a(world, i, j, k, i1, false, 0);
      boolean flag2 = false;
      if (flag1 && (i1 & 8) == 0) {
  ...
  private void func_4031_h(World world, int i, int j, int k, boolean flag) {
    if (world.multiplayerWorld) {
      ...
      (new RailLogic(this, world, i, j, k))
          .func_792_a(world.isBlockIndirectlyGettingPowered(i, j, k), flag);
      return;
    }
  }
