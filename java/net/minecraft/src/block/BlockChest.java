...
import net.minecraft.src.world.tile.TileEntityChest;
...
public class BlockChest extends BlockContainer {
  ...
  public int getBlockTexture(IBlockAccess iblockaccess, int i, int j, int k, int l) {
    ...
    if (i1 == blockID || j1 == blockID) {
      ...
      byte byte1 = 5;
      if ((Block.opaqueCubeLookup[k1] || Block.opaqueCubeLookup[k2])
          && !Block.opaqueCubeLookup[l1]
          && !Block.opaqueCubeLookup[i3]) {
        byte1 = 5;
      }
      if ((Block.opaqueCubeLookup[l1] || Block.opaqueCubeLookup[i3])
    ...
    if (k1 == blockID || l1 == blockID) {
      ...
      if ((Block.opaqueCubeLookup[j1] || Block.opaqueCubeLookup[j3])
