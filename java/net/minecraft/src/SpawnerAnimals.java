...
public final class SpawnerAnimals {
  ...
  static {
    nightSpawnEntities =
        (new Class[] {EntitySpider.class, EntityZombie.class, EntitySkeleton.class});
  }
  ...
  public static final int performSpawning(World var0, boolean var1, boolean var2) {
    if (!var1 && !var2) {
      ...
      for (int var37 = 0; var37 < var6; ++var37) {
        ...
        if ((!var38.getPeacefulCreature() || var2)
            && (var38.getPeacefulCreature() || var1)
            && var0.countEntities(var38.getCreatureClass())
                <= var38.getMaxNumberOfCreature() * eligibleChunksForSpawning.size() / 256) {
          ...
          while (var39.hasNext()) {
            ...
            if (var12 != null && !var12.isEmpty()) {
              ...
              for (Iterator var14 = var12.iterator();
                  var14.hasNext();
              ...
              ChunkPosition var41 =
                  getRandomSpawningPointInChunk(var0, var10.chunkXPos * 16, var10.chunkZPos * 16);
              int var42 = var41.x;
              int var18 = var41.y;
              int var19 = var41.z;
              if (!var0.isBlockNormalCube(var42, var18, var19)
                  && var0.getBlockMaterial(var42, var18, var19) == var38.getCreatureMaterial()) {
                int var20 = 0;
                ...
                for (int var21 = 0; var21 < 3; ++var21) {
                  ...
                  for (int var26 = 0; var26 < 4; ++var26) {
                    ...
                    if (canCreatureTypeSpawnAtLocation(var38, var0, var22, var23, var24)) {
                      ...
                      if (var0.getClosestPlayer(
                              (double) var27, (double) var28, (double) var29, 24.0D)
                          == null) {
                        ...
                        if (var33 >= 576.0F) {
                          ...
                          var43.setLocationAndAngles(
                              (double) var27,
                              (double) var28,
                              (double) var29,
                              var0.rand.nextFloat() * 360.0F,
                              0.0F);
  ...
  private static boolean canCreatureTypeSpawnAtLocation(
      EnumCreatureType enumcreaturetype, World world, int i, int j, int k) {
  ...
  private static void creatureSpecificInit(
      EntityLiving entityliving, World world, float f, float f1, float f2) {
  ...
  public static boolean performSleepSpawning(World world, List list) {
    ...
    do {
      ...
      if (aclass != null && aclass.length != 0) {
        ...
        while (i < 20 && !flag1) {
          int j =
              (MathHelper.floor_double(entityplayer.posX) + world.rand.nextInt(32))
                  - world.rand.nextInt(32);
          int k =
              (MathHelper.floor_double(entityplayer.posZ) + world.rand.nextInt(32))
                  - world.rand.nextInt(32);
          int l =
              (MathHelper.floor_double(entityplayer.posY) + world.rand.nextInt(16))
          ...
          for (;
              !canCreatureTypeSpawnAtLocation(EnumCreatureType.monster, world, j, j1, k)
                  && j1 < l + 16
                  && j1 < 128;
              j1++) {}
          if (j1 >= l + 16 || j1 >= 128) {
            ...
            if (entityliving.getCanSpawnHere()) {
              PathEntity pathentity =
                  pathfinder.createEntityPathTo(entityliving, entityplayer, 32F);
              if (pathentity != null && pathentity.pathLength > 1) {
                ...
                if (Math.abs((double) pathpoint.xCoord - entityplayer.posX) < 1.5D
                  ...
                  entityliving.setLocationAndAngles(
                      (float) chunkcoordinates.x + 0.5F,
                      chunkcoordinates.y,
                      (float) chunkcoordinates.z + 0.5F,
                      0.0F,
                      0.0F);
