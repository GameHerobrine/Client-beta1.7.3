...
public abstract class GuiSlotStats extends GuiSlot {
  ...
  protected GuiSlotStats(GuiStats guistats) {
    super(
        GuiStats.func_27143_f(guistats),
        guistats.width,
        guistats.height,
        32,
        guistats.height - 64,
  ...
  protected void func_27265_a(StatCrafting statcrafting, int i, int j, boolean flag) {
    if (statcrafting != null) {
      String s =
          statcrafting.func_27084_a(GuiStats.func_27142_c(field_27269_g).writeStat(statcrafting));
      field_27269_g.drawString(
          GuiStats.func_27133_h(field_27269_g),
          s,
          i - GuiStats.func_27137_i(field_27269_g).getStringWidth(s),
          j + 5,
      ...
      field_27269_g.drawString(
          ...
          s1,
          i - GuiStats.func_27134_k(field_27269_g).getStringWidth(s1),
          j + 5,
          flag ? 0xffffff : 0x909090);
    }
  }
  ...
  protected void func_27267_a(StatCrafting statcrafting, int i, int j) {
    ...
    String s =
        (new StringBuilder())
            .append("")
            .append(StringTranslate.getInstance().translateNamedKey(item.getItemName()))
            .toString()
            .trim();
    if (s.length() > 0) {
      int k = i + 12;
