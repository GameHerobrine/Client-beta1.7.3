...
public class GuiStats extends GuiScreen {
  ...
  public static StatFileWriter func_27142_c(GuiStats guistats) {
  ...
  private void func_27138_c(int i, int j, int k) {
    ...
    GL11.glPopMatrix();
    field_27153_j.drawItemIntoGui(
        fontRenderer, mc.renderEngine, k, 0, Item.itemsList[k].getIconFromDamage(0), i + 2, j + 2);
  ...
  private void func_27136_c(int i, int j, int k, int l) {
    ...
    tessellator.addVertexWithUV(
        i + 0, j + 18, zLevel, (float) (k + 0) * 0.0078125F, (float) (l + 18) * 0.0078125F);
    tessellator.addVertexWithUV(
        i + 18, j + 18, zLevel, (float) (k + 18) * 0.0078125F, (float) (l + 18) * 0.0078125F);
    tessellator.addVertexWithUV(
        i + 18, j + 0, zLevel, (float) (k + 18) * 0.0078125F, (float) (l + 0) * 0.0078125F);
    tessellator.addVertexWithUV(
        i + 0, j + 0, zLevel, (float) (k + 0) * 0.0078125F, (float) (l + 0) * 0.0078125F);
    tessellator.draw();
  }
}
