...
class GuiWorldSlot extends GuiSlot {
  ...
  public GuiWorldSlot(GuiSelectWorld guiselectworld) {
    super(
        guiselectworld.mc,
        guiselectworld.width,
        guiselectworld.height,
        32,
        guiselectworld.height - 64,
        36);
  ...
  protected void elementClicked(int i, boolean flag) {
    ...
    boolean flag1 =
        GuiSelectWorld.getSelectedWorld(parentWorldGui) >= 0
  ...
  protected void drawSlot(int i, int j, int k, int l, Tessellator tessellator) {
    SaveFormatComparator saveformatcomparator =
        (SaveFormatComparator) GuiSelectWorld.getSize(parentWorldGui).get(i);
    String s = saveformatcomparator.getDisplayName();
    if (s == null || MathHelper.stringNullOrLengthZero(s)) {
      s =
          (new StringBuilder())
              .append(GuiSelectWorld.func_22087_f(parentWorldGui))
              .append(" ")
              .append(i + 1)
              .toString();
    }
    ...
    s1 =
        (new StringBuilder())
            ...
            .append(" (")
            .append(
                GuiSelectWorld.getDateFormatter(parentWorldGui)
                    .format(new Date(saveformatcomparator.func_22163_e())))
            .toString();
    ...
    s1 =
        (new StringBuilder())
            .append(s1)
            .append(", ")
            .append((float) (((l1 / 1024L) * 100L) / 1024L) / 100F)
            .append(" MB)")
            .toString();
    String s2 = "";
    if (saveformatcomparator.func_22161_d()) {
      s2 =
          (new StringBuilder())
              .append(GuiSelectWorld.func_22088_h(parentWorldGui))
              .append(" ")
              .append(s2)
              .toString();
    }
