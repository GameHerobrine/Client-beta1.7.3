...
public class GuiConnecting extends GuiScreen {
  ...
  public GuiConnecting(Minecraft minecraft, String s, int i) {
    cancelled = false;
    System.out.println(
        (new StringBuilder()).append("Connecting to ").append(s).append(", ").append(i).toString());
  ...
  public static NetClientHandler setNetClientHandler(
      GuiConnecting guiconnecting, NetClientHandler netclienthandler) {
  ...
  public void initGui() {
    ...
    controlList.add(
        new GuiButton(
            0, width / 2 - 100, height / 4 + 120 + 12, stringtranslate.translateKey("gui.cancel")));
  }
  ...
  public void drawScreen(int i, int j, float f) {
    ...
    if (clientHandler == null) {
      ...
      drawCenteredString(
          ...
          0xffffff);
      drawCenteredString(
          fontRenderer, clientHandler.field_1209_a, width / 2, height / 2 - 10, 0xffffff);
    }
