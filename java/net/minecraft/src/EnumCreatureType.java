...
public enum EnumCreatureType {
  ...
  static {
    /*
            ...
            creature = new EnumCreatureType("creature", 1, net.minecraft.src.entity.EntityAnimal.class, 15, Material.air, true);
            waterCreature = new EnumCreatureType("waterCreature", 2, net.minecraft.src.entity.EntityWaterMob.class, 5, Material.water, true);
    */
