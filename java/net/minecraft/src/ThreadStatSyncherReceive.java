  ...
  public void run() {
    try {
      if (StatsSyncher.func_27422_a(field_27231_a) != null) {
        StatsSyncher.func_27412_a(
            field_27231_a,
            StatsSyncher.func_27422_a(field_27231_a),
            StatsSyncher.func_27423_b(field_27231_a),
            StatsSyncher.func_27411_c(field_27231_a),
            StatsSyncher.func_27413_d(field_27231_a));
      } else if (StatsSyncher.func_27423_b(field_27231_a).exists()) {
        StatsSyncher.func_27421_a(
            field_27231_a,
            StatsSyncher.func_27409_a(
                field_27231_a,
                StatsSyncher.func_27423_b(field_27231_a),
                StatsSyncher.func_27411_c(field_27231_a),
                StatsSyncher.func_27413_d(field_27231_a)));
